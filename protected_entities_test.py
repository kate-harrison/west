...
# PE.export_to_kml("digital_tv_towers.kml", filter_function=lambda x: x.is_digital())
...
PE_PLMRS.export_to_kml("metro_plmrs.kml", filter_function=lambda x: x.is_metro())
