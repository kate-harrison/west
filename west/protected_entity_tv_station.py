...
class ProtectedEntityTVStation(ProtectedEntity):
    ...
    required_properties = ["_latitude", "_longitude", "_channel",
                           "_ERP_Watts", "_HAAT_meters", "_tx_type",
                           "_facility_id", "_callsign", "_app_id"]

    def __init__(self, container, region, latitude, longitude, channel,
                 ERP_Watts, HAAT_meters, tx_type):
        super(ProtectedEntityTVStation, self).__init__(region, container,
                                                       latitude, longitude)
    ...
    def get_facility_id(self):
        """
        Returns a string containing the facility ID associated with the TV
        station (if any) or None.
        """
    ...
    def get_callsign(self):
        """
        Returns a string containing the callsign associated with the TV
        station (if any) or None.
        """
    ...
    def get_app_id(self):
        """Returns a string containing the application ID associated with
        this TV station (if any) or None."""
        return self._app_id
    ...
    def get_erp_kilowatts(self):
        """
        Returns the ERP (effective radiated power) of the TV station in
        kilowatts.
        """
    ...
    def get_haat_meters(self):
        """
        Returns the HAAT (height above average terrain) of the TV station in
        meters.
        """
    ...
    def get_tx_type(self):
        """
        Returns the transmitter type of the TV station (depends on source
        data). If possible, use :meth:`is_digital` and :meth:`is_analog` to
        avoid dependence on source data.
        """
        return self._tx_type

    def is_digital(self):
        """
        Returns True if the TV station is digital and False otherwise. See
        also :meth:`is_analog`.
        """
    ...
    def is_analog(self):
        """
        Returns True if the TV station is analog and False otherwise. See
        also :meth:`is_digital`.
        """
        return self._tx_type in self.container.analog_tv_types()

    def is_cochannel(self, channel):
        """
        Returns True if `channel` is the same as this station's channel and
        False otherwise.
        """
    ...
    def is_adjacent_channel(self, channel):
        """
        Returns True if `channel` is adjacent to this station's channel and
        False otherwise. See also
        :meth:`helpers.channels_are_adjacent_in_frequency`.
        """
        return helpers.channels_are_adjacent_in_frequency(
            self.container.get_mutable_region(), self._channel, channel)
    ...
    def add_to_kml(self, kml):
        ...
        Callsign: %s
        Facility ID: %s
        """ % (self.get_channel(), self.get_tx_type(), self.get_erp_kilowatts(),
               self.get_haat_meters(), self.get_latitude(),
               self.get_longitude(), self.get_callsign(),
